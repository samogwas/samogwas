...
int main() {
    ...
    load_labels_positions( *labels, *ids, *positions, "../example/inputs/labels/lab_3000.csv");
    ...
    auto mat = load_data_table("../example/inputs/data/dat_3000.csv");
    ...
    for (double epsi = 0.4 ; epsi <= 0.5 ;epsi +=0.1) {
        printf("\n*******************************************************************\nMinPt = 2, epsilon = %f\n\n",epsi);
